...
public class Client2Chat {
	public static void main(String[] args) {
		...
		try {
			...
			Client client = new Client("localhost", "3000", myId);
			ClientIDL stub = (ClientIDL)UnicastRemoteObject.exportObject(client, 0);
			
			Registry registro = LocateRegistry.createRegistry(3000);
			...
			try {
				...
				chat.connect("127.0.0.1","3000", myId);
